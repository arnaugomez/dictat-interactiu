...
export class Auth extends Context.Service<
  Auth,
  {
    readonly hashPassword: (plain: string) => Effect.Effect<string, CryptoError>;
    readonly verifyPassword: (plain: string, hash: string) => Effect.Effect<boolean, CryptoError>;
    readonly createSession: (userId: string) => Effect.Effect<string, DatabaseError>;
    ...
    >;
    readonly invalidateSession: (sessionId: string) => Effect.Effect<void, DatabaseError>;
    readonly invalidateAllUserSessions: (userId: string) => Effect.Effect<void, DatabaseError>;
    readonly generateEmailVerificationToken: (
      userId: string,
    ) => Effect.Effect<string, DatabaseError>;
    readonly verifyEmailVerificationToken: (
      token: string,
    ) => Effect.Effect<string, AuthError | DatabaseError>;
    readonly generatePasswordResetToken: (userId: string) => Effect.Effect<string, DatabaseError>;
    readonly verifyPasswordResetToken: (
      token: string,
    ) => Effect.Effect<string, AuthError | DatabaseError>;
  }
>()("@dictat/Auth") {}
...
export const AuthLive = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const verifyEmailVerificationToken = Effect.fn("Auth.verifyEmailVerificationToken")(function* (
      ...
      const result = yield* runDb(() =>
        db.query.emailVerificationTokens
          .findFirst({
