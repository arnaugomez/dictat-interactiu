...
export const AuthLive = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const verifyEmailVerificationToken = Effect.fn("Auth.verifyEmailVerificationToken")(
      function* (token: string) {
        const result = db.query.emailVerificationTokens.findFirst({
    ...
    const generatePasswordResetToken = Effect.fn("Auth.generatePasswordResetToken")(
      function* (userId: string) {
    ...
    const verifyPasswordResetToken = Effect.fn("Auth.verifyPasswordResetToken")(
      function* (token: string) {
        const result = db.query.passwordResetTokens.findFirst({
